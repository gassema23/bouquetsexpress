    ...
    return (
        <div>
            ...
            <div className='container mx-auto px-4 md:px-0'>
                ...
                <div className='flex w-full py-10 md:justify-center md:items-center flex-col md:flex-row'>
                    <div>
                    ...
                    <div className='md:pt-0 pt-4'>
                        <img src="/images/will-TWJmj182gu4-unsplash.jpg" alt="" className='h-auto md:max-w-lg md:mx-auto' />
                    </div>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-4 pb-10'>
                    ...
                    <TeamCard nom="Joseph McFall" image="/images/members/member-3.png" description="Technicien Fleuriste" />
                </div>
            </div>
        </div>
    )
